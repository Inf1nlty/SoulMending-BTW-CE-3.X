...
public class EnchantmentSoulMending extends Enchantment {

    public static EnchantmentSoulMending soulMending;
    public static final int SOUL_MENDING_ID = 100;
    public static ItemStack arcaneSoulMendingScroll;

    public EnchantmentSoulMending(int id, int weight) {
    ...
    public static void registerEnchantment() {
        soulMending = new EnchantmentSoulMending(SOUL_MENDING_ID, 5);
